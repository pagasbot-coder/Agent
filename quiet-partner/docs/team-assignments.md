...
**Уже закрыто (не вызывать):** T-001…T-032 (включ. PostHog runbook, Phase 5 doc BLOCKED impl).

**Следующий без Human:** dogfood log (Human OPTIONAL); M0 sign-off; live PostHog VPS keys (OPTIONAL).
