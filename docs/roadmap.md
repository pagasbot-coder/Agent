...
## Agents Window (рекомендуемые чаты)

Используйте **subagent** или правило роли + `@orchestration-queue.md`:

| Роль | Subagent | Правило |
|------|----------|---------|
| PM | `muster-pm` | `@role-pm` |
...
_Add via PM into orchestration queue._
