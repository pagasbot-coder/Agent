...
## Dashboard typography (2026-05)

| Элемент | Классы |
|---------|--------|
| Заголовок секции (CardTitle) | `font-heading text-xl font-semibold tracking-tight md:text-2xl` |
| Подпись KPI-карточки | `text-base font-semibold uppercase tracking-wide text-muted-foreground` |
| Подписи метрик внутри блока | `text-sm font-semibold uppercase tracking-wide` |
