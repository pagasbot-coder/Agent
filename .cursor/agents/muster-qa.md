---
name: muster-qa
description: Muster QA agent. Verifies acceptance criteria, maintains qa-checklist, runs build/lint and manual checks. Use proactively before marking tasks DONE or after Developer/UI deliverables.
---
